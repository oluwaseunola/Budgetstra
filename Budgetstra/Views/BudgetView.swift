        ...
        GeometryReader { geometry in
            ...
            ZStack(alignment:.top){
                        ...
                        if currentTab == .budget{
                            ...
                            List{
                                ...
                                ForEach(budgetViewModel.budgets, id: \.id) { budget in
                                    ...
                                    BudgetSavingTableCell(title: budget.title, budget: budget.budget, spent: budget.spent, currentTab: $currentTab)
                            ...
                            List{
                                ...
                                ForEach(budgetViewModel.savings, id: \.id) { saving in
                                    ...
                                    BudgetSavingTableCell(title: saving.title, budget: saving.total, spent: saving.saved, currentTab: $currentTab)
                                        .swipeActions(edge: .trailing, allowsFullSwipe: true) {
                ...
                if updateBudgetIsPresented {
                    ...
                    UpdateBudgetSavingComponent(budget: currentBudget, isPresented: $updateBudgetIsPresented, componentType:.constant(.budget))
                }
                
                if updateSavingIsPresented {
                    
                    UpdateBudgetSavingComponent(saving: currentSaving, isPresented: $updateSavingIsPresented, componentType:.constant(.saving))
